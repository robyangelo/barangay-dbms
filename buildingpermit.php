...
if(isset($_POST['submit'])){
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
			...
			$sql1 = "insert into buildingpermit_tbl(trans_id, name, zone_add, mop, ref, receipt, app_date) values('$trans_id', '$name','$zone_add','$mop','$ref','$fileName','$app_date')";
...
<html lang="en">
  ...
  <body>
    ...
    <form method="post"  action = "" class="form"  enctype="multipart/form-data">
      <h2 class="text-center">BUILDING PERMIT</h2>
