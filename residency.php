...
if(isset($_POST['submit'])){
	...
	$yrs_residency=$_POST['yrs_residency'];
	$mop=$_POST['mop'];
	$ref=$_POST['ref'];
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
			...
			$sql1 = "insert into residency_tbl(trans_id, name, zone_add, yrs_residency, mop, ref, receipt, app_date) values('$trans_id', '$name', '$zone_add','$yrs_residency', '$mop','$ref','$fileName','$app_date')";
...
<html lang="en">
  ...
  <body>
    ...
    <form method="post"  action = "" class="form" enctype="multipart/form-data">
      <h2 class="text-center">CERTIFICATE OF RESIDENCY</h2>
      ...
      <div class="form-step form-step-active">
        ...
        <div class="input-group">
		  ...
		  <div class="input-group">
            <label for="purpose">Years of Residency</label>
            <input type="text" name="yrs_residency" id="yrs_residency"  required />
          </div>
        <div class="">
