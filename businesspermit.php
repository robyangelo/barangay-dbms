...
if(isset($_POST['submit'])){
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
			...
			$sql1 = "insert into businesspermit_tbl(trans_id, cedula_no, name, business_name, zone_add, mop, ref, receipt, app_date) values('$trans_id', '$cedula_no', '$name', '$business_name', '$zone_add','$mop','$ref','$fileName','$app_date')";
    ...
    <form method="post"  action = "" class="form" enctype="multipart/form-data">
      ...
      <div class="form-step form-step-active">
        ...
        <div class="input-group">
		  ...
		  <div class="input-group">
            <label for="purpose">Business Name</label>
